...
{
	// Set up envs array
	// We don't need to do anything for initializing envs[i]
	// because envs has been memset'd, 
	// ENV_FREE is exactly 0, so is the required env_ids.
	// We're only adding them to the free list.
